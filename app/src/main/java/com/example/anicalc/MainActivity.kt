...
import com.example.anicalc.ui.screen.HomeScreen
import com.example.anicalc.ui.screen.timer.TimerScreen
import com.example.anicalc.ui.screen.unitconverter.UnitConverterScreen
import com.example.anicalc.ui.screen.calculator.CalculatorScreen
import com.example.anicalc.ui.theme.AnicalcTheme
import com.example.anicalc.util.Screen
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            AnicalcTheme(darkTheme = application.isDark) {
                                ...
                                IconButton(onClick = { application.toggleDarkTheme() }) {
                                    Icon(
                                        painter = painterResource(
                                            id = if (application.isDark) R.drawable.ic_baseline_dark_mode_24 else R.drawable.ic_outline_dark_mode_24),
