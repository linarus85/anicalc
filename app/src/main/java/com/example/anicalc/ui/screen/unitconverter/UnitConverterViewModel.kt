package com.example.anicalc.ui.screen.unitconverter
...
import com.example.anicalc.data.UnitConverterRepository
import com.example.anicalc.util.trimResult
        ...
        if (inputText.isNotEmpty()) {
            ...
            when (selectedUnitIndex) {
                2 -> { // Currency
                    ...
                    val fromCurrency =
                        mediatorSubunitList[subunitIndex1].substringAfter("(").substringBefore(")")
                            .lowercase()
                    val toCurrency =
                        mediatorSubunitList[subunitIndex2].substringAfter("(").substringBefore(")")
                            .lowercase()
                ...
                10 -> { // Temperature
                    ...
                    val coefficient1 =
                        mediatorSubunitList[subunitIndex1].split(",").last().toDouble()
                    val coefficient2 =
                        mediatorSubunitList[subunitIndex2].split(",").last().toDouble()
