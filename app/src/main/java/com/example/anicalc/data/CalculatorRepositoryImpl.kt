...
import com.example.anicalc.util.PreferencesKeys
...
class CalculatorRepositoryImpl @Inject constructor
    (private val dataStore: DataStore<Preferences>) : CalculatorRepository {
    override fun saveCalculator(
    ...
    override suspend fun getOperationsList(): List<Pair<String, String>> =
    ...
    override suspend fun getAngleType(): CalculatorViewModel.AngleType =
        dataStore.data.map { preferences ->
            val ordinal = preferences[PreferencesKeys.CALCULATOR_ANGLE_TYPE]
                ?: CalculatorViewModel.AngleType.DEGREE.ordinal
